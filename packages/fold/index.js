...
function fold(text) { return foldToVector.call(this, text).join(this?.delim ?? LF) }
 ...
 * @constructor
 */
const FoldToVector = (config) => foldToVector.bind(config);
 ...
 * @constructor
 */
const Fold = (config) => fold.bind(config);
